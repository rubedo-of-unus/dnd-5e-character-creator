...
equipmentSelect.addEventListener("change", () => {
  ...
  if (currentEquipmentType === "add-weapons") {
    ...
    Type: ${chosenWeapon.type.substring(0, 1).toUpperCase() + chosenWeapon.type.substring(1).toLowerCase()}
    `;
    ...
    addedArmour.addEventListener("click", () => {
      ...
      if (isThisEquipped) {
        ...
        const selectedArmour = armors.find(
          (armour) => armour.name === match[1],
        );
      ...
      if (equippedArmourDiv) {
        // Find the previous armour's parts
        //const prevAdded = equippedArmourDiv.querySelector("[data-equipped-label]") || equippedArmourDiv.querySelector("div:last-child");
        //const prevControls = equippedArmourDiv.querySelector("div"); // your quantity container is first child
